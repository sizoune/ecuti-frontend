...
import { useCutiBalance, useCutiStatistics } from "#/hooks/use-cuti";
									...
									<div>
										<div className="h-2 w-full overflow-hidden rounded-full bg-muted">
											<div
												...
												style={{
													width: `${Math.min(100, item.terpakai * 5)}%`,
												}}
											/>
										</div>
										<p className="mt-1 text-xs text-muted-foreground">
											{item.terpakai === 0
												? "Belum ada penggunaan cuti"
												: `${item.terpakai} hari telah digunakan`}
										</p>
									</div>
								</CardContent>
							</Card>
