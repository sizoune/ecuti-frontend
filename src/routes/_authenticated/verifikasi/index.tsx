...
export const Route = createFileRoute("/_authenticated/verifikasi/")({
	beforeLoad: () => {
		...
		try {
			...
			if (!["Admin SKPD", "Admin Uker", "Pegawai"].includes(user.role)) {
				throw redirect({ to: "/" });
			}
		} catch {
			throw redirect({ to: "/" });
		...
		<div className="space-y-4">
			<div>
				...
				<p className="text-muted-foreground">
					Kelola verifikasi pengajuan cuti pegawai
				</p>
			</div>
								...
								<AlertDialogContent>
									<AlertDialogHeader>
										...
										<AlertDialogDescription>
											...
											<strong>{cuti.pegawai_nama}</strong>? Status akan diubah
											menjadi <strong>Disetujui</strong>.
										</AlertDialogDescription>
									</AlertDialogHeader>
									<AlertDialogFooter>
								...
								<AlertDialogContent>
									<AlertDialogHeader>
										...
										<AlertDialogDescription>
											...
											<strong>{cuti.pegawai_nama}</strong>? Tindakan ini tidak
											dapat dibatalkan.
										</AlertDialogDescription>
									</AlertDialogHeader>
									<AlertDialogFooter>
